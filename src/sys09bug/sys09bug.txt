...
* ADDED:  "DE2-70" STRING
*
* Modified to SYS09BUG VER 1.8
* BY:     JOHN KENT
* DATE:   25TH APR 2012
* ADDED:  REMOVED ACINIZ FROM LOADS ROUTINE
*         SO THAT IT DOES NOT CORRUPT THE "L" CHARACTER
*         ADD HFCOPT CONDITIONAL ON ACINIZ TO CONTROL
*         RTS HAND SHAKE
*
*       *** COMMANDS ***
*
